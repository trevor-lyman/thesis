...
bulk_soil_density <- 1.63 # g dwt per cm^3?
# https://sis.agr.gc.ca/cansis/publications/manuals/1984-peat/ca1984_2e_report.pdf
g_per_m2 <- cm3_in_m2*bulk_soil_density*0.25 # cm3_in_m2 * bulk_soil_density 
...
# create plot
total.ab_plot <- 
  ggplot(abundance_figs, aes(x=tx, y=total_ab_standardized, fill = as.factor(destructive_time))) + 
