...
cor.test(abundance_data1$total_micro_ab_standardized, abundance_data1$total_meso_ab_standardized, method = c("pearson"))
cor.test(abundance_data1$total_ab_standardized, abundance_data1$total_meso_ab_standardized, method = c("pearson"))
cor.test(abundance_data1$total_ab_standardized, abundance_data1$total_micro_ab_standardized, method = c("pearson"))
