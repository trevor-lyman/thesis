...
consumption_plot <- 
  ...
  scale_fill_brewer(palette = "Greys") +
  xlab("Environmental Treatment Condition") + 
  ylab(expression("Total consumptive flux (g C / m"^2*" / yr)")) +
  labs(fill = "Sampling Time", pch = "Sampling Time")
...
Cmin_plot <- 
  ...
  scale_fill_brewer(palette = "Greys") +
  xlab("Environmental Treatment Condition") + 
  ylab(expression("Carbon mineralization (g C / m"^2*" / yr)")) +
  labs(fill = "Sampling Time", pch = "Sampling Time")
...
flux_df1 <- as.data.frame(matrix(data = c(
  ...
  "Total Consumptive Flux",
  "Levene's Test",
  levene_test(total_consumption ~ 
                (moisture_tx * temp_tx * destructive_time), 
              data = flux_data_T1uT2)$df1,
  levene_test(total_consumption ~ 
                (moisture_tx * temp_tx * destructive_time), 
