...
Five experimental mesocosms were destructively sampled following a three-week recovery period but prior to deployment of the experimental treatments (T~0~). The following conditions were recorded for these five control mesocosms and were assumed to be representative of field values. The mean heterotrophic respiration (&plusmn; SE) prior to implementing experimental soil moisture and temperature conditions at T~0~ was `r format(round(mean(resp_T0$cum_resp), digits = get_round_digit(signif(sd(resp_T0$cum_resp)/sqrt(length(resp_T0$cum_resp)), digits = 1))), nsmall = 1)` &plusmn; `r signif(sd(resp_T0$cum_resp)/sqrt(length(resp_T0$cum_resp)), digits = 1)` ln(g of C per m^2^ per year), which equates to ~`r comma(round(mean(exp(resp_T0$cum_resp)), digits = get_round_digit(signif(sd(exp(resp_T0$cum_resp))/sqrt(length(resp_T0$cum_resp)), digits = 1))))` &plusmn; `r signif(sd(exp(resp_T0$cum_resp))/sqrt(length(resp_T0$cum_resp)), digits = 1)` g of C per m^2^ per year. The mean soil moisture (&plusmn; SE) was `r round(mean(soil_T0$pct_moisture), digits = get_round_digit(signif(sd(soil_T0$pct_moisture)/sqrt(length(soil_T0$pct_moisture)), digits = 1)))` &plusmn; `r signif(sd(soil_T0$pct_moisture)/sqrt(length(soil_T0$pct_moisture)), digits = 1)`% based on a dry weight gravimetric measurement, while the average soil pH (&plusmn; SE) was `r round(mean(soil_T0$pH), digits = get_round_digit(signif(sd(soil_T0$pH)/sqrt(length(soil_T0$pH)), digits = 1)))` &plusmn; `r signif(sd(soil_T0$pH)/sqrt(length(soil_T0$pH)), digits = 1)`. Mean C:N ratio (&plusmn; SE) was `r round(mean(soil_T0$C_N_ratio), digits = get_round_digit(signif(sd(soil_T0$C_N_ratio)/sqrt(length(soil_T0$C_N_ratio)), digits = 1)))` &plusmn; `r signif(sd(soil_T0$C_N_ratio)/sqrt(length(soil_T0$C_N_ratio)), digits = 1)`, while mean microbial enzymatic activity (&plusmn; SE) was `r round(mean(soil_T0$Phenox), digits = get_round_digit(signif(sd(soil_T0$Phenox)/sqrt(length(soil_T0$Phenox)), digits = 1)))` &plusmn; `r signif(sd(soil_T0$Phenox)/sqrt(length(soil_T0$Phenox)), digits = 1)` &mu;mol substrate per g soil per hour for phenol oxidase and `r round(mean(soil_T0$Perox), digits = get_round_digit(signif(sd(soil_T0$Perox)/sqrt(length(soil_T0$Perox)), digits = 1)))` &plusmn; `r signif(sd(soil_T0$Perox)/sqrt(length(soil_T0$Perox)), digits = 1)` &mu;mol substrate per g soil per hour for peroxidase concentration. The mean total microfauna, mesofauna, and total fauna abundances (&plusmn; SE) were: `r comma(round(mean(abundance_T0$total_micro_ab_standardized), digits = get_round_digit(signif(sd(abundance_T0$total_micro_ab_standardized)/sqrt(length(abundance_T0$total_micro_ab_standardized)), digits = 1))))` (&plusmn; `r comma(signif(sd(abundance_T0$total_micro_ab_standardized)/sqrt(length(abundance_T0$total_micro_ab_standardized)), digits = 1))`), `r comma(round(mean(abundance_T0$total_meso_ab_standardized), digits = get_round_digit(signif(sd(abundance_T0$total_meso_ab_standardized)/sqrt(length(abundance_T0$total_meso_ab_standardized)), digits = 1))))` (&plusmn; `r comma(signif(sd(abundance_T0$total_meso_ab_standardized)/sqrt(length(abundance_T0$total_meso_ab_standardized)), digits = 1))`), and `r comma(round(mean(abundance_T0$total_ab_standardized), digits = get_round_digit(signif(sd(abundance_T0$total_ab_standardized)/sqrt(length(abundance_T0$total_ab_standardized)), digits = 1))))` (&plusmn; `r comma(signif(sd(abundance_T0$total_ab_standardized)/sqrt(length(abundance_T0$total_ab_standardized)), digits = 1))`) individuals per m^2^, respectively.
<br>

### Supplemental Table 3.1
Summary table of mean (&plusmn; SE) heterotrophic respiration, soil moisture, pH, C:N ratio, phenol oxidase concentration, peroxidase concentration, total microfauna abundance, total mesofauna abundance, and total fauna abundance prior to deployment of the experimental treatments (T~0~). Units for each parameter are displayed in the table.
...
Converting faunal abundance to biomass estimates, I calculated mean microfauna, mesofauna and total fauna biomass (&plusmn; SE) as `r round(mean(biomass_T0$micro_biomass), digits = get_round_digit(signif(sd(biomass_T0$micro_biomass)/sqrt(length(biomass_T0$micro_biomass)), digits = 1)))` (&plusmn; `r signif(sd(biomass_T0$micro_biomass)/sqrt(length(biomass_T0$micro_biomass)), digits = 1)`), `r round(mean(biomass_T0$meso_biomass), digits = get_round_digit(signif(sd(biomass_T0$meso_biomass)/sqrt(length(biomass_T0$meso_biomass)), digits = 1)))` (&plusmn; `r signif(sd(biomass_T0$meso_biomass)/sqrt(length(biomass_T0$meso_biomass)), digits = 1)`), and `r round(mean(biomass_T0$total_biomass), digits = get_round_digit(signif(sd(biomass_T0$total_biomass)/sqrt(length(biomass_T0$total_biomass)), digits = 1)))` (&plusmn; `r signif(sd(biomass_T0$total_biomass)/sqrt(length(biomass_T0$total_biomass)), digits = 1)`) g of C per m^2^, respectively. Mean total consumptive flux (&plusmn; SE) based on the energetic model was `r comma(round(mean(flux_T0$total_consumption), digits = get_round_digit(signif(sd(flux_T0$total_consumption)/sqrt(length(flux_T0$total_consumption)), digits = 1))))` &plusmn; `r signif(sd(flux_T0$total_consumption)/sqrt(length(flux_T0$total_consumption)), digits = 1)` g of C per m^2^ per year, while the mean total C mineralization (&plusmn; SE) was `r round(mean(flux_T0$total_Cmin), digits = get_round_digit(signif(sd(flux_T0$total_Cmin)/sqrt(length(flux_T0$total_Cmin)), digits = 1)))` &plusmn; `r signif(sd(flux_T0$total_Cmin)/sqrt(length(flux_T0$total_Cmin)), digits = 1)` g of C per m^2^ per year, and the mean total N mineralization (&plusmn; SE) was `r format(round(mean(flux_T0$total_Nmin), digits = get_round_digit(signif(sd(flux_T0$total_Nmin)/sqrt(length(flux_T0$total_Nmin)), digits = 1))), nsmall = 1)` &plusmn; `r signif(sd(flux_T0$total_Nmin)/sqrt(length(flux_T0$total_Nmin)), digits = 1)` g of N per m^2^ per year. Mean values are presented in [Appendix D].
<br>

### Supplemental Table 3.2
Summary table of mean (&plusmn; SE) microfauna biomass, mesofauna biomass, total biomass, total consumption, total C mineralization, and total N mineralization prior to deployment of the experimental treatments (T~0~). Units for each parameter are displayed in the table.
```{r T0 Results 4, warning=F}
...
### Figure 3.1 
Boxplots of mean heterotrophic soil respiration (ln transformed).
...
Shapiro-Wilk and Levene's Tests constructed to test whether log-transformed heterotrophic soil respiration conforms to the assumptions of normality and homodescacity, respectively. 
...
resp_assumptions <- as.data.frame(matrix(data = c(
  "Shapiro-Wilk Test", 
  paste0("W = ", round(shapiro_test(residuals(resp_lm2))$statistic, 3)),
  paste0("p = ", round(shapiro_test(residuals(resp_lm2))$p.value, 3)),
  "Levene's Test",
  paste0("F", sub_digits(
    levene_test(cum_resp ~ (moisture_tx * temp_tx * destructive_time), 
              data = resp_T1uT2)$df1), "\u02CC",
  sub_digits(levene_test(cum_resp ~ (moisture_tx * temp_tx * destructive_time), 
              data = resp_T1uT2)$df2), " = ",
...
Heterotrophic respiration was transformed on natural log, (ln) scale to conform to the assumption of normality. Log-transformed soil heterotrophic respiration satisfied the assumptions of normality and homodescacity, as per a Shapiro-Wilk (`r paste0("W = ", round(shapiro_test(residuals(resp_lm2))$statistic, 3))`, `r paste0("p = ", round(shapiro_test(residuals(resp_lm2))$p.value, 3))`) and Levene’s test (`r paste0("F", sub_digits(levene_test(cum_resp ~ (moisture_tx * temp_tx * destructive_time), data = resp_T1uT2)$df1), "\u02CC", sub_digits(levene_test(cum_resp ~ (moisture_tx * temp_tx * destructive_time), data = resp_T1uT2)$df2), " = ", round(levene_test(cum_resp ~ (moisture_tx * temp_tx * destructive_time), data = resp_T1uT2)$statistic, 3))`, `r paste0("p = ", round(levene_test(cum_resp ~ (moisture_tx * temp_tx * destructive_time), data = resp_T1uT2)$p, 3))`). Log-transformed heterotrophic respiration, estimated for each mesocosm ([Figure 3.1]), was not significantly affected by soil moisture (`r paste0("F", sub_digits(resp_aov2["moisture_tx", "Df"]), "\u02CC", sub_digits(resp_aov2["Residuals", "Df"]), " = ", format(round(resp_aov2["moisture_tx", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(resp_aov2["moisture_tx", "Pr(>F)"], 3), nsmall = 3))`), nor temperature (`r paste0("F", sub_digits(resp_aov2["temp_tx", "Df"]), "\u02CC", sub_digits(resp_aov2["Residuals", "Df"]), " = ", format(round(resp_aov2["temp_tx", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(resp_aov2["temp_tx", "Pr(>F)"], 3), nsmall = 3))`); heterotrophic respiration tended to be greater in mesocosms assigned to 20 &deg;C vs. 12 &deg;C. Neither destructive sampling time (`r paste0("F", sub_digits(resp_aov2["destructive_time", "Df"]), "\u02CC", sub_digits(resp_aov2["Residuals", "Df"]), " = ", format(round(resp_aov2["destructive_time", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(resp_aov2["destructive_time", "Pr(>F)"], 3), nsmall = 3))`) nor block effects (`r paste0("F", sub_digits(resp_aov2["block_effect", "Df"]), "\u02CC", sub_digits(resp_aov2["Residuals", "Df"]), " = ", format(round(resp_aov2["block_effect", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(resp_aov2["block_effect", "Pr(>F)"], 3), nsmall = 3))`) used to account for differences in field sampling location significantly affected log-transformed respiration. There were no significant interaction effects between soil moisture, temperature, and destructive sampling time ([Appendix E]). Mean soil heterotrophic respiration (&plusmn; SE) under each treatment is presented in [Appendix D]. Estimates of effect size based on a linear model are given in [Appendix F].
<br>
  
### Supplemental Table 3.4
Log-transformed heterotrophic respiration ANOVA results.
```{r Resp Results 3}
resp_aov_tbl <- as.data.frame(matrix(data = c(
  "Intercept",
  paste0("F", sub_digits(resp_aov2["(Intercept)", "Df"]), 
         "\u02CC", sub_digits(resp_aov2["Residuals", "Df"]), 
         " = ", format(round(resp_aov2["(Intercept)", "F value"], 3), 
                       nsmall = 3)),
  paste0("p = ", format(round(resp_aov2["(Intercept)", "Pr(>F)"], 3), 
                       nsmall = 3)),
  "Soil Moisture Treatment",
  paste0("F", sub_digits(resp_aov2["moisture_tx", "Df"]), 
         "\u02CC", sub_digits(resp_aov2["Residuals", "Df"]), 
         " = ", format(round(resp_aov2["moisture_tx", "F value"], 3), 
                       nsmall = 3)),
  paste0("p = ", format(round(resp_aov2["moisture_tx", "Pr(>F)"], 3), 
                       nsmall = 3)),
  "Temperature Treatment",
  paste0("F", sub_digits(resp_aov2["temp_tx", "Df"]), 
         "\u02CC", sub_digits(resp_aov2["Residuals", "Df"]), 
         " = ", format(round(resp_aov2["temp_tx", "F value"], 3), 
                       nsmall = 3)),
  paste0("p = ", format(round(resp_aov2["temp_tx", "Pr(>F)"], 3), 
                       nsmall = 3)),
  "Destructive Sampling Treatment",
  paste0("F", sub_digits(resp_aov2["destructive_time", "Df"]), 
         "\u02CC", sub_digits(resp_aov2["Residuals", "Df"]), 
         " = ", format(round(resp_aov2["destructive_time", "F value"], 3), 
                       nsmall = 3)),
  paste0("p = ", format(round(resp_aov2["destructive_time", "Pr(>F)"], 3), 
                       nsmall = 3)),
  "Block Effect",
  paste0("F", sub_digits(resp_aov2["block_effect", "Df"]), 
         "\u02CC", sub_digits(resp_aov2["Residuals", "Df"]), 
         " = ", format(round(resp_aov2["block_effect", "F value"], 3), 
                       nsmall = 3)),
  paste0("p = ", format(round(resp_aov2["block_effect", "Pr(>F)"], 3), 
                       nsmall = 3))
), ncol = 3, byrow = T))

colnames(resp_aov_tbl) <- c("Parameter", "Statistic", "P-Value")

knitr::kable(resp_aov_tbl)
```
<br>

## 3.3 Physical Soil Properties
### Figure 3.2 
Soil moisture (A), pH (B), and C:N ratio (C).
...
Soil moisture and pH were transformed on natural log, (ln) scale to conform to the assumption of normality. Soil moisture and pH were measured across 37 experimental mesocosms; in addition to sample ExRes 5, one large positive outlier (point estimates: 7.10 ln(%), 1.55 ln(pH)) and one large negative outlier (point estimates: 6.34 ln(%), 1.28 ln(pH)) were removed to help conform to the assumptions of normality. Soil C:N ratio was compared across 36 mesocosms, as three samples could not be processed due to the mass and packing of the sample and size limitations of the CNSH autosampler. Log-transformed soil moisture (Shapiro-Wilk’s test: `r paste0("W= ", format(round(shapiro_test(residuals(soil_moisture_lm2))$statistic, 3), nsmall = 3))`, `r paste0("p = ", format(round(shapiro_test(residuals(soil_moisture_lm2))$p.value, 3), nsmasll = 3))`; Levene’s test: `r paste0("F", sub_digits(levene_test(log(pct_moisture) ~ (moisture_tx * temp_tx * destructive_time), data = soil_T1uT2)$df1), "\u02CC", sub_digits(levene_test(log(pct_moisture) ~ (moisture_tx * temp_tx * destructive_time), data = soil_T1uT2)$df2), " = ", format(round(levene_test(log(pct_moisture) ~ (moisture_tx * temp_tx * destructive_time), data = soil_T1uT2)$statistic, 3), nsmall = 3))`, `r paste0("p = ", format(round(levene_test(log(pct_moisture) ~ (moisture_tx * temp_tx * destructive_time), data = soil_T1uT2)$p, 3), nsmall = 3))`), log-transformed pH (Shapiro-Wilk’s test: `r paste0("W= ", format(round(shapiro_test(residuals(pH_lm2))$statistic, 3), nsmall = 3))`, `r paste0("p = ", format(round(shapiro_test(residuals(pH_lm2))$p.value, 3), nsmasll = 3))`; Levene’s test: `r paste0("F", sub_digits(levene_test(log(pH) ~ (moisture_tx * temp_tx * destructive_time), data = soil_T1uT2)$df1), "\u02CC", sub_digits(levene_test(log(pH) ~ (moisture_tx * temp_tx * destructive_time), data = soil_T1uT2)$df2), " = ", format(round(levene_test(log(pH) ~ (moisture_tx * temp_tx * destructive_time), data = soil_T1uT2)$statistic, 3), nsmall = 3))`, `r paste0("p = ", format(round(levene_test(log(pH) ~ (moisture_tx * temp_tx * destructive_time), data = soil_T1uT2)$p, 3), nsmall = 3))`), and C:N ratio (Shapiro-Wilk’s test: `r paste0("W= ", format(round(shapiro_test(residuals(CN_lm2))$statistic, 3), nsmall = 3))`, `r paste0("p = ", format(round(shapiro_test(residuals(CN_lm2))$p.value, 3), nsmasll = 3))`; Levene’s test: `r paste0("F", sub_digits(levene_test(C_N_ratio ~ (moisture_tx * temp_tx * destructive_time), data = soil_T1uT2)$df1), "\u02CC", sub_digits(levene_test(C_N_ratio ~ (moisture_tx * temp_tx * destructive_time), data = soil_T1uT2)$df2), " = ", format(round(levene_test(C_N_ratio ~ (moisture_tx * temp_tx * destructive_time), data = soil_T1uT2)$statistic, 3), nsmall = 3))`, `r paste0("p = ", format(round(levene_test(C_N_ratio ~ (moisture_tx * temp_tx * destructive_time), data = soil_T1uT2)$p, 3), nsmall = 3))`) each satisfied the assumptions of normality and homogeneity of variance.
<br>
...
soil_df1 <- as.data.frame(matrix(data = c(
  ...
  "Shapiro-Wilk Test", 
  paste0("W= ", 
         format(round(shapiro_test(residuals(pH_lm2))$statistic, 3), 
         nsmall = 3)),
  paste0("p = ", 
         format(round(shapiro_test(residuals(pH_lm2))$p.value, 3),
         nsmasll = 3)),
  "Soil pH",
  "Levene's Test",
  paste0("F", sub_digits(
  ...
  "Shapiro-Wilk Test", 
  paste0("W= ", 
         format(round(shapiro_test(residuals(CN_lm2))$statistic, 3), 
         nsmall = 3)),
  paste0("p = ", 
         format(round(shapiro_test(residuals(CN_lm2))$p.value, 3),
         nsmasll = 3)),
  "Soil C:N Ratio",
  "Levene's Test",
  paste0("F", sub_digits(
  ...
  sub_digits(
    levene_test(C_N_ratio ~ (moisture_tx * temp_tx * destructive_time), 
              data = soil_T1uT2)$df2), " = ",
  format(round(levene_test(C_N_ratio ~ 
                             (moisture_tx * temp_tx * destructive_time), 
              data = soil_T1uT2)$statistic, 3), nsmall = 3)),
  paste0("p = ", 
         format(round(levene_test(C_N_ratio ~ 
...
colnames(soil_df1) <- c("Parameter", "Test", "Statistic", "P-Value")
...
Mean soil moisture ([Figure 3.2]A) was significantly related to the induced soil moisture treatments and significantly greater in saturated vs. field-moist treatments (`r paste0("F", sub_digits(soil_moisture_aov2["moisture_tx", "Df"]), "\u02CC", sub_digits(soil_moisture_aov2["Residuals", "Df"]), " = ", format(round(soil_moisture_aov2["moisture_tx", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(soil_moisture_aov2["moisture_tx", "Pr(>F)"], 3), nsmall = 3))`) and was significantly greater in 20 &deg;C vs. 12 &deg;C treatments (`r paste0("F", sub_digits(soil_moisture_aov2["temp_tx", "Df"]), "\u02CC", sub_digits(soil_moisture_aov2["Residuals", "Df"]), " = ", format(round(soil_moisture_aov2["temp_tx", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(soil_moisture_aov2["temp_tx", "Pr(>F)"], 3), nsmall = 3))`). Soil moisture was not affected by destructive sampling time (`r paste0("F", sub_digits(soil_moisture_aov2["destructive_time", "Df"]), "\u02CC", sub_digits(soil_moisture_aov2["Residuals", "Df"]), " = ", format(round(soil_moisture_aov2["destructive_time", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(soil_moisture_aov2["destructive_time", "Pr(>F)"], 3), nsmall = 3))`) nor block effects (`r paste0("F", sub_digits(soil_moisture_aov2["block_effect", "Df"]), "\u02CC", sub_digits(soil_moisture_aov2["Residuals", "Df"]), " = ", format(round(soil_moisture_aov2["block_effect", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(soil_moisture_aov2["block_effect", "Pr(>F)"], 3), nsmall = 3))`). There were no significant interaction effects between soil moisture, temperature, and destructive sampling time ([Appendix E]). Mean soil moisture is presented in [Appendix D]. Estimates of effect size based on a linear model are given in [Appendix F].
<br>
  
### Supplemental Table 3.6
Log-transformed soil moisture ANOVA results.
```{r Soil Results 4}
soil_moisture_aov_tbl <- as.data.frame(matrix(data = c(
  "Intercept",
  paste0("F", sub_digits(soil_moisture_aov2["(Intercept)", "Df"]), 
         "\u02CC", sub_digits(soil_moisture_aov2["Residuals", "Df"]), 
         " = ", format(round(soil_moisture_aov2["(Intercept)", "F value"], 3), 
                       nsmall = 3)),
  paste0("p = ", format(round(soil_moisture_aov2["(Intercept)", "Pr(>F)"], 3), 
                       nsmall = 3)),
  "Soil Moisture Treatment",
  paste0("F", sub_digits(soil_moisture_aov2["moisture_tx", "Df"]), 
         "\u02CC", sub_digits(soil_moisture_aov2["Residuals", "Df"]), 
         " = ", format(round(soil_moisture_aov2["moisture_tx", "F value"], 3), 
                       nsmall = 3)),
  paste0("p = ", format(round(soil_moisture_aov2["moisture_tx", "Pr(>F)"], 3), 
                       nsmall = 3)),
  "Temperature Treatment",
  paste0("F", sub_digits(soil_moisture_aov2["temp_tx", "Df"]), 
         "\u02CC", sub_digits(soil_moisture_aov2["Residuals", "Df"]), 
         " = ", format(round(soil_moisture_aov2["temp_tx", "F value"], 3), 
                       nsmall = 3)),
  paste0("p = ", format(round(soil_moisture_aov2["temp_tx", "Pr(>F)"], 3), 
                       nsmall = 3)),
  "Destructive Sampling Treatment",
  paste0("F", sub_digits(soil_moisture_aov2["destructive_time", "Df"]), 
         "\u02CC", sub_digits(soil_moisture_aov2["Residuals", "Df"]), 
         " = ", format(round(soil_moisture_aov2["destructive_time", "F value"], 
                             3), 
                       nsmall = 3)),
  paste0("p = ", format(round(soil_moisture_aov2["destructive_time", "Pr(>F)"], 
                              3), 
                       nsmall = 3)),
  "Block Effect",
  paste0("F", sub_digits(soil_moisture_aov2["block_effect", "Df"]), 
         "\u02CC", sub_digits(soil_moisture_aov2["Residuals", "Df"]), 
         " = ", format(round(soil_moisture_aov2["block_effect", "F value"], 3), 
                       nsmall = 3)),
  paste0("p = ", format(round(soil_moisture_aov2["block_effect", "Pr(>F)"], 3), 
                       nsmall = 3))
), ncol = 3, byrow = T))

colnames(soil_moisture_aov_tbl) <- c("Parameter", "Statistic", "P-Value")

knitr::kable(soil_moisture_aov_tbl)
```
<br>
...
Mean soil pH ([Figure 3.2]B) was not significantly influenced by soil moisture (`r paste0("F", sub_digits(pH_aov2["moisture_tx", "Df"]), "\u02CC", sub_digits(pH_aov2["Residuals", "Df"]), " = ", format(round(pH_aov2["moisture_tx", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(pH_aov2["moisture_tx", "Pr(>F)"], 3), nsmall = 3))`) nor temperature (`r paste0("F", sub_digits(pH_aov2["temp_tx", "Df"]), "\u02CC", sub_digits(pH_aov2["Residuals", "Df"]), " = ", format(round(pH_aov2["temp_tx", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(pH_aov2["temp_tx", "Pr(>F)"], 3), nsmall = 3))`) treatments. Destructive sampling time exhibited a significant effect on pH (`r paste0("F", sub_digits(pH_aov2["destructive_time", "Df"]), "\u02CC", sub_digits(pH_aov2["Residuals", "Df"]), " = ", format(round(pH_aov2["destructive_time", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(pH_aov2["destructive_time", "Pr(>F)"], 3), nsmall = 3))`) and pH tended to be greater in mesocosms sampled at T~2~ vs. T~1~, but block effects did not explain differences in pH between treatments (`r paste0("F", sub_digits(pH_aov2["block_effect", "Df"]), "\u02CC", sub_digits(pH_aov2["Residuals", "Df"]), " = ", format(round(pH_aov2["block_effect", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(pH_aov2["block_effect", "Pr(>F)"], 3), nsmall = 3))`). There were no significant interaction effects between soil moisture, temperature, and destructive sampling time ([Appendix E]). Mean soil pH is presented in [Appendix D]. Estimates of effect size based on a linear model are given in [Appendix F].
<br>
  
### Supplemental Table 3.7
Log-transformed soil pH ANOVA results.
```{r Soil Results 6}
pH_aov_tbl <- as.data.frame(matrix(data = c(
  "Intercept",
  paste0("F", sub_digits(pH_aov2["(Intercept)", "Df"]), 
         "\u02CC", sub_digits(pH_aov2["Residuals", "Df"]), 
         " = ", format(round(pH_aov2["(Intercept)", "F value"], 3), 
                       nsmall = 3)),
  paste0("p = ", format(round(pH_aov2["(Intercept)", "Pr(>F)"], 3), 
                       nsmall = 3)),
  "Soil Moisture Treatment",
  paste0("F", sub_digits(pH_aov2["moisture_tx", "Df"]), 
         "\u02CC", sub_digits(pH_aov2["Residuals", "Df"]), 
         " = ", format(round(pH_aov2["moisture_tx", "F value"], 3), 
                       nsmall = 3)),
  paste0("p = ", format(round(pH_aov2["moisture_tx", "Pr(>F)"], 3), 
                       nsmall = 3)),
  "Temperature Treatment",
  paste0("F", sub_digits(pH_aov2["temp_tx", "Df"]), 
         "\u02CC", sub_digits(pH_aov2["Residuals", "Df"]), 
         " = ", format(round(pH_aov2["temp_tx", "F value"], 3), 
                       nsmall = 3)),
  paste0("p = ", format(round(pH_aov2["temp_tx", "Pr(>F)"], 3), 
                       nsmall = 3)),
  "Destructive Sampling Treatment",
  paste0("F", sub_digits(pH_aov2["destructive_time", "Df"]), 
         "\u02CC", sub_digits(pH_aov2["Residuals", "Df"]), 
         " = ", format(round(pH_aov2["destructive_time", "F value"], 
                             3), 
                       nsmall = 3)),
  paste0("p = ", format(round(pH_aov2["destructive_time", "Pr(>F)"], 
                              3), 
                       nsmall = 3)),
  "Block Effect",
  paste0("F", sub_digits(pH_aov2["block_effect", "Df"]), 
         "\u02CC", sub_digits(pH_aov2["Residuals", "Df"]), 
         " = ", format(round(pH_aov2["block_effect", "F value"], 3), 
                       nsmall = 3)),
  paste0("p = ", format(round(pH_aov2["block_effect", "Pr(>F)"], 3), 
                       nsmall = 3))
), ncol = 3, byrow = T))

colnames(pH_aov_tbl) <- c("Parameter", "Statistic", "P-Value")

knitr::kable(pH_aov_tbl)
```
<br>
...
Soil C:N ([Figure 3.2]C) did not show any clear trends across treatments. Neither soil moisture (`r paste0("F", sub_digits(CN_aov2["moisture_tx", "Df"]), "\u02CC", sub_digits(CN_aov2["Residuals", "Df"]), " = ", format(round(CN_aov2["moisture_tx", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(CN_aov2["moisture_tx", "Pr(>F)"], 3), nsmall = 3))`), temperature (`r paste0("F", sub_digits(CN_aov2["temp_tx", "Df"]), "\u02CC", sub_digits(CN_aov2["Residuals", "Df"]), " = ", format(round(CN_aov2["temp_tx", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(CN_aov2["temp_tx", "Pr(>F)"], 3), nsmall = 3))`), nor destructive sampling time (`r paste0("F", sub_digits(CN_aov2["destructive_time", "Df"]), "\u02CC", sub_digits(CN_aov2["Residuals", "Df"]), " = ", format(round(CN_aov2["destructive_time", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(CN_aov2["destructive_time", "Pr(>F)"], 3), nsmall = 3))`) had a significant effect on soil C:N ratio. There was no significant difference in C:N ratio between treatments corresponding to block effects (`r paste0("F", sub_digits(CN_aov2["block_effect", "Df"]), "\u02CC", sub_digits(CN_aov2["Residuals", "Df"]), " = ", format(round(CN_aov2["block_effect", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(CN_aov2["block_effect", "Pr(>F)"], 3), nsmall = 3))`) and there were no significant interaction effects between soil moisture, temperature, and destructive sampling time ([Appendix E]). Mean C:N (&plusmn; SE) under each treatment is presented in [Appendix D]. Estimates of effect size based on a linear model are given in [Appendix F].
<br>
  
### Supplemental Table 3.8
Soil C:N ratio ANOVA results.
```{r Soil Results 8}
CN_aov_tbl <- as.data.frame(matrix(data = c(
  "Intercept",
  paste0("F", sub_digits(CN_aov2["(Intercept)", "Df"]), 
         "\u02CC", sub_digits(CN_aov2["Residuals", "Df"]), 
         " = ", format(round(CN_aov2["(Intercept)", "F value"], 3), 
                       nsmall = 3)),
  paste0("p = ", format(round(CN_aov2["(Intercept)", "Pr(>F)"], 3), 
                       nsmall = 3)),
  "Soil Moisture Treatment",
  paste0("F", sub_digits(CN_aov2["moisture_tx", "Df"]), 
         "\u02CC", sub_digits(CN_aov2["Residuals", "Df"]), 
         " = ", format(round(CN_aov2["moisture_tx", "F value"], 3), 
                       nsmall = 3)),
  paste0("p = ", format(round(CN_aov2["moisture_tx", "Pr(>F)"], 3), 
                       nsmall = 3)),
  "Temperature Treatment",
  paste0("F", sub_digits(CN_aov2["temp_tx", "Df"]), 
         "\u02CC", sub_digits(CN_aov2["Residuals", "Df"]), 
         " = ", format(round(CN_aov2["temp_tx", "F value"], 3), 
                       nsmall = 3)),
  paste0("p = ", format(round(CN_aov2["temp_tx", "Pr(>F)"], 3), 
                       nsmall = 3)),
  "Destructive Sampling Treatment",
  paste0("F", sub_digits(CN_aov2["destructive_time", "Df"]), 
         "\u02CC", sub_digits(CN_aov2["Residuals", "Df"]), 
         " = ", format(round(CN_aov2["destructive_time", "F value"], 
                             3), 
                       nsmall = 3)),
  paste0("p = ", format(round(CN_aov2["destructive_time", "Pr(>F)"], 
                              3), 
                       nsmall = 3)),
  "Block Effect",
  paste0("F", sub_digits(CN_aov2["block_effect", "Df"]), 
         "\u02CC", sub_digits(CN_aov2["Residuals", "Df"]), 
         " = ", format(round(CN_aov2["block_effect", "F value"], 3), 
                       nsmall = 3)),
  paste0("p = ", format(round(CN_aov2["block_effect", "Pr(>F)"], 3), 
                       nsmall = 3))
), ncol = 3, byrow = T))

colnames(CN_aov_tbl) <- c("Parameter", "Statistic", "P-Value")

knitr::kable(CN_aov_tbl)
```
<br>
...
```{r Figure 3-3, warning=F, fig.cap="Measurements were taken across experimental treatments of temperature (12 &deg;C, 20 &deg;C) and soil moisture (field-moist, saturated) destructively sampled after three-weeks (T~1~) or following three-week recovery period (T~2~). Letters denote significant differences between groups, as per Tukey’s HSD test.", out.width = '100%'}
...
Mean phenol oxidase activity was measured across 38 mesocosms. One anomalous negative reading indicating an issue with instrumental background noise was excluded from both phenol oxidase and peroxidase comparisons. Peroxidase activity was compared across 37 mesocosms, as one large positive outlier (point estimate = 323 &mu;mol substrate per g soil per hour) was additionally omitted. Mean phenol oxidase (Shapiro-Wilk: `r paste0("W = ", format(round(shapiro_test(residuals(phenox_lm2))$statistic, 3), nsmall = 3))`, `r paste0("p = ", format(round(shapiro_test(residuals(phenox_lm2))$p.value, 3), nsmasll = 3))`; Levene: `r paste0("F", sub_digits(levene_test(Phenox ~ (moisture_tx * temp_tx * destructive_time), data = soil_T1uT2)$df1), "\u02CC", sub_digits(levene_test(Phenox ~ (moisture_tx * temp_tx * destructive_time), data = soil_T1uT2)$df2), " = ", format(round(levene_test(Phenox ~ (moisture_tx * temp_tx * destructive_time), data = soil_T1uT2)$statistic, 3), nsmall = 3))`, `r paste0("p = ", format(round(levene_test(Phenox ~ (moisture_tx * temp_tx * destructive_time), data = soil_T1uT2)$p, 3), nsmall = 3))`) and peroxidase (Shapiro-Wilk: `r paste0("W = ", format(round(shapiro_test(residuals(perox_lm2))$statistic, 3), nsmall = 3))`, `r paste0("p = ", format(round(shapiro_test(residuals(perox_lm2))$p.value, 3), nsmasll = 3))`; Levene: `r paste0("F", sub_digits(levene_test(Perox ~ (moisture_tx * temp_tx * destructive_time), data = soil_T1uT2)$df1), "\u02CC", sub_digits(levene_test(Perox ~ (moisture_tx * temp_tx * destructive_time), data = soil_T1uT2)$df2), " = ", format(round(levene_test(Perox ~ (moisture_tx * temp_tx * destructive_time), data = soil_T1uT2)$statistic, 3), nsmall = 3))`, `r paste0("p = ", format(round(levene_test(Perox ~ (moisture_tx * temp_tx * destructive_time), data = soil_T1uT2)$p, 3), nsmall = 3))`) activity satisfied the assumptions of normality and homogeneity of variance, as per a Shapiro-Wilk test and Levene’s test, respectively.
<br>
...
Mean phenol oxidase activity ([Figure 3.3]A) was not significantly affected by soil moisture treatments (`r paste0("F", sub_digits(phenox_aov2["moisture_tx", "Df"]), "\u02CC", sub_digits(phenox_aov2["Residuals", "Df"]), " = ", format(round(phenox_aov2["moisture_tx", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(phenox_aov2["moisture_tx", "Pr(>F)"], 3), nsmall = 3))`), but was strongly driven by temperature conditions (`r paste0("F", sub_digits(phenox_aov2["temp_tx", "Df"]), "\u02CC", sub_digits(phenox_aov2["Residuals", "Df"]), " = ", format(round(phenox_aov2["temp_tx", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(phenox_aov2["temp_tx", "Pr(>F)"], 3), nsmall = 3))`). Mean phenol oxidase activity increased in mesocosms assigned to 20 &deg;C vs. 12 &deg;C conditions. Destructive sampling treatments also significantly affected phenol oxidase activity (`r paste0("F", sub_digits(phenox_aov2["destructive_time", "Df"]), "\u02CC", sub_digits(phenox_aov2["Residuals", "Df"]), " = ", format(round(phenox_aov2["destructive_time", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(phenox_aov2["destructive_time", "Pr(>F)"], 3), nsmall = 3))`) and was greater at T~2~ vs. T~1~. This was driven by a significant temperature by destructive sampling time interaction (`r paste0("F", sub_digits(phenox_aov2["temp_tx:destructive_time", "Df"]), "\u02CC", sub_digits(phenox_aov2["Residuals", "Df"]), " = ", format(round(phenox_aov2["temp_tx:destructive_time", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(phenox_aov2["temp_tx:destructive_time", "Pr(>F)"], 3), nsmall = 3))`), which suggests that phenol oxidase activity decreased in mesocosms assigned to 20 &deg;C from T~1~ to T~2~ following a three-week return to initial 12 &deg;C conditions. Block effects constructed corresponding to differences in total abundance by original sampling location (`r paste0("F", sub_digits(phenox_aov2["block_effect", "Df"]), "\u02CC", sub_digits(phenox_aov2["Residuals", "Df"]), " = ", format(round(phenox_aov2["block_effect", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(phenox_aov2["block_effect", "Pr(>F)"], 3), nsmall = 3))`) did not have a significant effect on phenol oxidase activity. There were no other significant interaction effects between soil moisture, temperature, and destructive sampling time ([Appendix E]). Overall, mean phenol oxidase activity (&plusmn; SE) was greatest (199 &plusmn; 24 &mu;mol substrate per g soil per hour) in mesocosms assigned to 20 &deg;C field-moist conditions, sampled at T~1~ and was least (90 &plusmn; 19 &mu;mol substrate per g soil per hour) in those assigned to 12 &deg;C saturated conditions, sampled at T~1~ (see [Appendix D]). Estimates of effect size based on a linear model are given in [Appendix F].
<br>
...
Mean peroxidase activity ([Figure 3.3]B) was not influenced by soil moisture (`r paste0("F", sub_digits(perox_aov2["moisture_tx", "Df"]), "\u02CC", sub_digits(perox_aov2["Residuals", "Df"]), " = ", format(round(perox_aov2["moisture_tx", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(perox_aov2["moisture_tx", "Pr(>F)"], 3), nsmall = 3))`), but was significantly affected by temperature (`r paste0("F", sub_digits(perox_aov2["temp_tx", "Df"]), "\u02CC", sub_digits(perox_aov2["Residuals", "Df"]), " = ", format(round(perox_aov2["temp_tx", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(perox_aov2["temp_tx", "Pr(>F)"], 3), nsmall = 3))`) and increased at 20 &deg;C vs 12 &deg;C. Mean peroxidase activity was also significantly affected by destructive sampling treatments (`r paste0("F", sub_digits(perox_aov2["destructive_time", "Df"]), "\u02CC", sub_digits(perox_aov2["Residuals", "Df"]), " = ", format(round(perox_aov2["destructive_time", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(perox_aov2["destructive_time", "Pr(>F)"], 3), nsmall = 3))`) and was greater in mesocosms sampled at T~2~ vs. T~1~. This was driven by a significant temperature by destructive sampling time interaction (`r paste0("F", sub_digits(perox_aov2["temp_tx:destructive_time", "Df"]), "\u02CC", sub_digits(perox_aov2["Residuals", "Df"]), " = ", format(round(perox_aov2["temp_tx:destructive_time", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(perox_aov2["temp_tx:destructive_time", "Pr(>F)"], 3), nsmall = 3))`), which suggests that peroxidase activity also decreased in mesocosms assigned to 20 &deg;C from T~1~ to T~2~ following a three-week return to initial 12 &deg;C conditions. Block effects also significantly influenced mean peroxidase activity (`r paste0("F", sub_digits(perox_aov2["block_effect", "Df"]), "\u02CC", sub_digits(perox_aov2["Residuals", "Df"]), " = ", format(round(perox_aov2["block_effect", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(perox_aov2["block_effect", "Pr(>F)"], 3), nsmall = 3))`); peroxidase activity tended to decrease in blocks characterized by especially high soil fauna abundances. There were no other significant interaction effects between soil moisture, temperature, and destructive sampling time ([Appendix E]). Mean peroxidase concentration (&plusmn; SE) under each treatment is presented in [Appendix D]. Estimates of effect size based on a linear model are given in [Appendix F].
<br>
...
```{r Figure 3-4, warning=F, fig.cap="Mesocosms were assessed across experimental treatments of temperature (12 &deg;C, 20 &deg;C) and soil moisture (field-moist, saturated) destructively sampled after three-weeks (T~1~) or following three-week recovery period (T~2~).", out.width = '100%'}
...
```{r Abundance and Biomass Results 1, warning=F}
...
Mean total soil fauna abundance (Shapiro-Wilk’s test: `r paste0("W = ", format(round(shapiro_test(residuals(total_ab_lm2))$statistic, 3), nsmall = 3))`, `r paste0("p = ", format(round(shapiro_test(residuals(total_ab_lm2))$p.value, 3), nsmasll = 3))`; Levene’s test: `r paste0("F", sub_digits(levene_test(total_ab_standardized ~ (moisture_tx * temp_tx * destructive_time), data = abundance_T1uT2)$df1), "\u02CC", sub_digits(levene_test(total_ab_standardized ~ (moisture_tx * temp_tx * destructive_time), data = abundance_T1uT2)$df2), " = ", format(round(levene_test(total_ab_standardized ~ (moisture_tx * temp_tx * destructive_time), data = abundance_T1uT2)$statistic, 3), nsmall = 3))`, `r paste0("p = ", format(round(levene_test(total_ab_standardized ~ (moisture_tx * temp_tx * destructive_time), data = abundance_T1uT2)$p, 3), nsmall = 3))`) and total soil microfauna abundance (Shapiro-Wilk’s test: `r paste0("W = ", format(round(shapiro_test(residuals(micro_ab_lm2))$statistic, 3), nsmall = 3))`, `r paste0("p = ", format(round(shapiro_test(residuals(micro_ab_lm2))$p.value, 3), nsmasll = 3))`; Levene’s test: `r paste0("F", sub_digits(levene_test(total_micro_ab_standardized ~ (moisture_tx * temp_tx * destructive_time), data = abundance_T1uT2)$df1), "\u02CC", sub_digits(levene_test(total_micro_ab_standardized ~ (moisture_tx * temp_tx * destructive_time), data = abundance_T1uT2)$df2), " = ", format(round(levene_test(total_micro_ab_standardized ~ (moisture_tx * temp_tx * destructive_time), data = abundance_T1uT2)$statistic, 3), nsmall = 3))`, p = 0.480) each satisfied the assumptions of normality and homogeneity of variance, as per a Shapiro-Wilk’s test and Levene’s test. Total soil mesofauna abundance was transformed on natural log, (ln) scale to conform to the assumption of normality (Shapiro-Wilk’s test: W = 0.976, p = 0.564; Levene’s test: F~7,31~ = 0.389, p = 0.901). Total biomass (Shapiro-Wilk’s test: W = 0.953, p = 0.107; Levene’s test: F~7,31~ = 0.317, p = 0.940), total soil microfauna biomass (Shapiro-Wilk’s test: W = 0.980, p = 0.704; Levene’s test: F~7,31~ = 0.955, p = 0.480), and total soil mesofauna biomass (Shapiro-Wilk’s test: W = 0.953, p = 0.105; Levene’s test: F~7,31~ = 0.313, p = 0.943) each met the assumptions of normality and homogeneity of variance.
<br>
...
```{r Abundance and Biomass Results 2, warning=F}
...
```{r Abundance and Biomass Results 3, warning=F}
cor_micro_meso_ab <- 
...
Total soil microfauna and mesofauna abundances were significantly correlated (R~42~ = 0.467, p = 0.001); similarly, soil microfauna (R~42~ = 0.834, p < 0.001) and mesofauna (R~42~ = 0.877, p < 0.001) total abundances were each significantly and positively correlated with total fauna abundance. Mean total soil fauna abundance ([Figure 3.4]A) was strongly influenced by the original sampling location (i.e., significant block effects (F~1,34~ = 22.953, p < 0.001)) with a high abundance of both microfauna and mesofauna observed in a single block that contained one sample replicate from each treatment. Total abundance of soil fauna was significantly reduced under saturated vs. field-moist conditions (F~1,34~ = 19.104, p < 0.001). This was driven by decreased microfauna (F~1,34~ = 21.152, p < 0.001) and mesofauna (F~1,33~ = 6.143, p = 0.018) abundances. Destructive sampling did not affect total fauna abundance (F~1,34~ = 0.466, p = 0.499), soil microfauna abundance (F~1,34~ = 0.966, p = 0.33), nor soil mesofauna abundance (F~1,33~ = 1.968, p = 0.170). Neither total soil fauna abundance nor soil microfauna abundance was significantly affected by interaction effects ([Appendix E]), but soil mesofauna exhibited a significant temperature by destructive sampling time interaction effect (F~1,33~ = 4.276, p = 0.047). This suggests that soil mesofauna abundances in mesocosms assigned to 20 &deg;C decreased from T~1~ to T~2~ following a three-week return to initial 12 &deg;C conditions. Overall, mean total abundance (&plusmn; SE) was greatest (360,000 &plusmn; 70,000 individuals per m^2^) in mesocosms assigned to 20 &deg;C field-moist conditions, sampled at T~1~ and was lowest (150,000 &plusmn; 30,000 individuals per m^2^) in those assigned to 12 &deg;C saturated conditions, sampled at T~1~ (see [Appendix D]). Estimates of effect size based on a linear model are given in [Appendix F].
<br>
  
### Supplemental Table 3.13
Total soil fauna, microfauna, and mesofauna abundance Pearson's Test results.
```{r Abundance and Biomass Results 4, warning=F}
...
```{r Abundance and Biomass Results 5, warning=F}
...
```{r Abundance and Biomass Results 6, warning=F}
cor_micro_meso_biom <- 
...
Following trends in soil fauna abundance, total soil microfauna and mesofauna biomasses were significantly correlated (R~42~ = 0.460, p = 0.002) as was total soil microfauna (R~42~ = 0.478, p = 0.001) and mesofauna (R~42~ = 0.999, p < 0.001) biomasses with total faunal biomass. Mean total biomass ([Figure 3.4]B) was strongly related to the original sampling location (F~1,33~ = 17.288, p < 0.001). Total biomass was significantly reduced saturated conditions (F~1,33~ = 8.631, p = 0.006). This was driven by a significant decrease in both soil microfauna (F~1,34~ = 21.152, p < 0.001) and mesofauna (F~1,33~ = 8.266, p = 0.007). Total biomass was not influenced by temperature conditions (F~1,33~ = 0.076, p = 0.784) nor the timing of destructive sampling (F~1,33~ = 1.375, p = 0.249). Soil microfauna biomass was not influenced by significant interaction effects ([Appendix E]), but total fauna (F~1,33~ = 3.386, p = 0.075) and soil mesofauna (F~1,33~ = 3.439, p = 0.073) biomasses exhibited weak soil moisture by destructive sampling time interaction effects. This suggests that the biomasses of total fauna and soil mesofauna in mesocosms assigned to saturated conditions tended to increase from T~1~ to T~2~ following a three-week return to initial field-moist conditions. Overall, mean total biomass (&plusmn; SE) was greatest (0.49 &plusmn; 0.10 g of C per m^2^ per year) in mesocosms assigned to 12 &deg;C field-moist conditions, sampled at T~1~ and was least (0.25 &plusmn; 0.07 g of C per m^2^ per year) in those assigned to 12 &deg;C saturated conditions, sampled at T~1~ (see [Appendix D]). Estimates of effect size based on a linear model are given in [Appendix F].
<br>
  
### Supplemental Table 3.15
Total soil fauna, microfauna, and mesofauna biomass Pearson's Test results.
```{r Abundance and Biomass Results 7, warning=F}
...
```{r Abundance and Biomass Results 8, warning=F}
...
```{r NMDS T1 Model Building, include = F}
ab_NMDS_T1 <- ab_NMDS %>%
...
metadata_T1$moisture_tx <- as.character(metadata_T1$moisture_tx)
metadata_T1$temp_tx <- as.character(metadata_T1$temp_tx)
metadata_T1$destructive_time <- as.factor(metadata_T1$destructive_time)
metadata_T1$block_effect <- as.factor(metadata_T1$block_effect)

T1 <- ab_NMDS_T1[order(row.names(ab_NMDS_T1)), ]
metadata_T1 <- metadata_T1 %>%
  mutate(temp_tx = fct_recode(temp_tx,
    "12 \u00B0C" = "12",
    "20 \u00B0C" = "20"
  )) %>%
    mutate(moisture_tx = fct_recode(moisture_tx,
    "Field-Moist" = "Ambient",
    "Saturated" = "High"
  ))
...
# Create the dynamic caption
fig3_5_caption <- paste0(
  "Non-metric multidimensional scaling plot of mesocosm similarity at T~1~. ",
  "(A) mesocosms show significant dissimilarity in community composition between field-moist and saturated moisture conditions; ",
  "(B) mesocosms show similarity in community composition between temperature treatments. ",
  "Stress = ", round(T1.mds$stress, 3), 
  ". Ellipses represent 95% CI based on similarity between samples."
)
```

### Figure 3.5
Non-metric multidimensional scaling plot of mesocosm similarity at T~1~.
```{r Figure 3-5, warning=F, fig.cap=fig3_5_caption, out.width = '100%', fig.height=8}
# T1 NMDS
# build the plot
...
Reductions in total fauna abundance under saturated soil moisture conditions were driven by Mesostigmata, Collembola, and juvenile and adult oribatid mites at T~1~ ([Appendix C]). In all cases the reductions under saturated conditions were more pronounced at 12 &deg;C than 20 &deg;C, with Collembola completely absent in 12 &deg;C saturated mesocosms. Warmer temperatures slightly increased juvenile Oribatida. Thus, moisture conditions had a significant effect (PerMANOVA F~1,17~ = 3.23, p= 0.045) on the overall community composition of the fauna ([Figure 3.5]A). Mesocosms were also significant different depending on where they were initially sampled (i.e., block effect PerMANOVA F~1,17~ = 4.35, p= 0.009). Temperature did not significantly affect
community composition; however, the community was much more homogeneous under warmed (20 &deg;C) conditions ([Figure 3.5]B).

### Supplemental Table 3.17
T1 Community PerMANOVA results.
```{r NMDS Results 2, warning=F}
...
```{r NMDS T2 Model Building, include = F}
ab_NMDS_T2 <- ab_NMDS %>%
...
metadata_T2$moisture_tx <- as.character(metadata_T2$moisture_tx)
metadata_T2$temp_tx <- as.character(metadata_T2$temp_tx)
metadata_T2$destructive_time <- as.factor(metadata_T2$destructive_time)
metadata_T2$block_effect <- as.factor(metadata_T2$block_effect)
...
metadata_T2 <- metadata_T1[order(row.names(metadata_T2)), ]

# Create the dynamic caption
fig3_6_caption <- paste0(
  "Non-metric multidimensional scaling plot of mesocosm similarity at T~2~. ",
  "(A) mesocosms show significant dissimilarity in community composition between field-moist and saturated moisture conditions; ",
  "(B) mesocosms show similarity in community composition between temperature treatments. ",
  "Stress = ", round(T2.mds$stress, 3), 
  ". Ellipses represent 95% CI based on similarity between samples."
)
```
<br>
...
### Figure 3.6
Non-metric multidimensional scaling plot of mesocosm similarity at T~2~.
```{r Figure 3-6, warning=F, fig.cap=fig3_6_caption, out.width = '100%', fig.height=8}
...
The soil food web fauna remained significantly different between the mesocosms that received saturated conditions vs. those under field-moist conditions even after three weeks recovery (T~2~) time (Moisture effect PerMANOVA F~1,18~ = 5.64, p= 0.003; [Figure 3.6]A). The experimental effects of temperature treatment did not significantly affect the soil fauna community composition, and the trend towards homogeneity under increased temperature treatment was not observed following the T~2~ recovery period ([Figure 3.6]B).
<br>
  
### Supplemental Table 3.18
T2 Community PerMANOVA results.
```{r NMDS Results 4, warning=F}
...
```{r Figure 3-7, warning=F, fig.cap="Fluxes were modeled across experimental treatments of temperature (12 &deg;C, 20 &deg;C) and soil moisture (field-moist, saturated) destructively sampled after three-weeks (T~1~) or following three-week recovery period (T~2~). Letters denote significant differences between groups, as per Tukey’s HSD test.", out.width = '100%'}
...
Mean total consumptive flux, C mineralization, and N mineralization were compared across 39 mesocosms. Mean total consumptive flux (`r paste0("W = ", format(round(shapiro_test(residuals(consumption_lm2))$statistic, 3), nsmall = 3))`, `r paste0("p = ", format(round(shapiro_test(residuals(consumption_lm2))$p.value, 3), nsmasll = 3))`), C mineralization (`r paste0("W = ", format(round(shapiro_test(residuals(Cmin_lm2))$statistic, 3), nsmall = 3))`, `r paste0("p = ", format(round(shapiro_test(residuals(Cmin_lm2))$p.value, 3), nsmasll = 3))`), and N mineralization (`r paste0("W = ", format(round(shapiro_test(residuals(Nmin_lm2))$statistic, 3), nsmall = 3))`, `r paste0("p = ", format(round(shapiro_test(residuals(Nmin_lm2))$p.value, 3), nsmasll = 3))`) met the assumption of normality, per a Shapiro-Wilk test. Mean total consumptive flux (`r paste0("F", sub_digits(levene_test(total_consumption ~ (moisture_tx * temp_tx * destructive_time), data = flux_data_T1uT2)$df1), "\u02CC", sub_digits(levene_test(total_consumption ~ (moisture_tx * temp_tx * destructive_time), data = flux_data_T1uT2)$df2), " = ", format(round(levene_test(total_consumption ~ (moisture_tx * temp_tx * destructive_time), data = flux_data_T1uT2)$statistic, 3), nsmall = 3))`, `r paste0("p = ", format(round(levene_test(total_consumption ~ (moisture_tx * temp_tx * destructive_time), data = flux_data_T1uT2)$p, 3), nsmall = 3))`), C mineralization (`r paste0("F", sub_digits(levene_test(total_Cmin ~ (moisture_tx * temp_tx * destructive_time), data = flux_data_T1uT2)$df1), "\u02CC", sub_digits(levene_test(total_Cmin ~ (moisture_tx * temp_tx * destructive_time), data = flux_data_T1uT2)$df2), " = ", format(round(levene_test(total_Cmin ~ (moisture_tx * temp_tx * destructive_time), data = flux_data_T1uT2)$statistic, 3), nsmall = 3))`, `r paste0("p = ", format(round(levene_test(total_Cmin ~ (moisture_tx * temp_tx * destructive_time), data = flux_data_T1uT2)$p, 3), nsmall = 3))`), and N mineralization (`r paste0("F", sub_digits(levene_test(total_Nmin ~ (moisture_tx * temp_tx * destructive_time), data = flux_data_T1uT2)$df1), "\u02CC", sub_digits(levene_test(total_Nmin ~ (moisture_tx * temp_tx * destructive_time), data = flux_data_T1uT2)$df2), " = ", format(round(levene_test(total_Nmin ~ (moisture_tx * temp_tx * destructive_time), data = flux_data_T1uT2)$statistic, 3), nsmall = 3))`, `r paste0("p = ", format(round(levene_test(total_Nmin ~ (moisture_tx * temp_tx * destructive_time), data = flux_data_T1uT2)$p, 3), nsmall = 3))`) also met the assumption of homogeneity of variance, per Levene’s test.
<br>
...
Mean total consumptive flux of C through the soil fauna food web ([Figure 3.7]A) was significantly related to block effects (`r paste0("F", sub_digits(consumption_aov2["block_effect", "Df"]), "\u02CC", sub_digits(consumption_aov2["Residuals", "Df"]), " = ", format(round(consumption_aov2["block_effect", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(consumption_aov2["block_effect", "Pr(>F)"], 3), nsmall = 3))`), and was greater in blocks characterized by especially high soil fauna abundances. Total C flux also significantly decreased under saturation (`r paste0("F", sub_digits(consumption_aov2["moisture_tx", "Df"]), "\u02CC", sub_digits(consumption_aov2["Residuals", "Df"]), " = ", format(round(consumption_aov2["moisture_tx", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(consumption_aov2["moisture_tx", "Pr(>F)"], 3), nsmall = 3))`), but significantly increased at 20 &deg;C vs. 12 &deg;C (`r paste0("F", sub_digits(consumption_aov2["temp_tx", "Df"]), "\u02CC", sub_digits(consumption_aov2["Residuals", "Df"]), " = ", format(round(consumption_aov2["temp_tx", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(consumption_aov2["temp_tx", "Pr(>F)"], 3), nsmall = 3))`). This was driven by a significant temperature-by-sampling time interaction effect (`r paste0("F", sub_digits(consumption_aov2["temp_tx:destructive_time", "Df"]), "\u02CC", sub_digits(consumption_aov2["Residuals", "Df"]), " = ", format(round(consumption_aov2["temp_tx:destructive_time", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(consumption_aov2["temp_tx:destructive_time", "Pr(>F)"], 3), nsmall = 3))`), which highlights that mean total flux in mesocosms assigned to 20 &deg;C decreased at T~2~ following a three-week return to 12 &deg;C field-moist conditions. Destructive sampling treatments alone did not significantly affect C flux (`r paste0("F", sub_digits(consumption_aov2["destructive_time", "Df"]), "\u02CC", sub_digits(consumption_aov2["Residuals", "Df"]), " = ", format(round(consumption_aov2["destructive_time", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(consumption_aov2["destructive_time", "Pr(>F)"], 3), nsmall = 3))`). No other interaction effects significantly affected C flux ([Appendix E]). Mean total flux (&plusmn; SE) under each treatment is presented in [Appendix D]. Estimates of effect size based on a linear model are given in [Appendix F].
<br>
  
### Supplemental Table N+1
Total consumptive flux ANOVA results.
```{r Flux Results 4, warning = F}
...
Total C mineralization of the soil food web ([Figure 3.7]B) followed similar trends to total C flux whereby experimental block effects were significant (`r paste0("F", sub_digits(Cmin_aov2["block_effect", "Df"]), "\u02CC", sub_digits(Cmin_aov2["Residuals", "Df"]), " = ", format(round(Cmin_aov2["block_effect", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(Cmin_aov2["block_effect", "Pr(>F)"], 3), nsmall = 3))`). Total C mineralization increased at 20 &deg;C vs. 12 &deg;C (`r paste0("F", sub_digits(Cmin_aov2["temp_tx", "Df"]), "\u02CC", sub_digits(Cmin_aov2["Residuals", "Df"]), " = ", format(round(Cmin_aov2["temp_tx", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(Cmin_aov2["temp_tx", "Pr(>F)"], 3), nsmall = 3))`), but decreased under saturated vs. field-moist soil moisture conditions (`r paste0("F", sub_digits(Cmin_aov2["moisture_tx", "Df"]), "\u02CC", sub_digits(Cmin_aov2["Residuals", "Df"]), " = ", format(round(Cmin_aov2["moisture_tx", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(Cmin_aov2["moisture_tx", "Pr(>F)"], 3), nsmall = 3))`). Destructive sampling treatments alone did not affect C mineralization (`r paste0("F", sub_digits(Cmin_aov2["destructive_time", "Df"]), "\u02CC", sub_digits(Cmin_aov2["Residuals", "Df"]), " = ", format(round(Cmin_aov2["destructive_time", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(Cmin_aov2["destructive_time", "Pr(>F)"], 3), nsmall = 3))`), but C mineralization was influenced by a significant temperature by destructive sampling time interaction effect (`r paste0("F", sub_digits(Cmin_aov2["temp_tx:destructive_time", "Df"]), "\u02CC", sub_digits(Cmin_aov2["Residuals", "Df"]), " = ", format(round(Cmin_aov2["temp_tx:destructive_time", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(Cmin_aov2["temp_tx:destructive_time", "Pr(>F)"], 3), nsmall = 3))`), highlighting that total C mineralization in mesocosms assigned to 20 &deg;C decreased at T~2~ following a three-week return to 12 &deg;C field-moist conditions. No other interaction effects significantly influenced C mineralization ([Appendix E]). Following three weeks of assigned experimental soil moisture and temperature conditions at T~1~ destructive sampling, C mineralization represented ~41% of total flux in mesocosms assigned to 12 &deg;C conditions, and 42% of total flux in mesocosms assigned to 20 &deg;C conditions. For all mesocosms, during the three weeks of recovery under field (12 &deg;C field-moist) conditions (i.e., T~2~ destructive sampling), C mineralization remained at ~41% of the total flux. Mean total C mineralization (&plusmn; SE) under each treatment is presented in [Appendix D]. Estimates of effect size based on a linear model are given in [Appendix F].
<br>
  
### Supplemental Table N+2
Carbon mineralization ANOVA results.
```{r Flux Results 6, warning = F}
...
Mean total N mineralization ([Figure 3.7]C) was significantly influenced by both soil moisture (`r paste0("F", sub_digits(Nmin_aov2["moisture_tx", "Df"]), "\u02CC", sub_digits(Nmin_aov2["Residuals", "Df"]), " = ", format(round(Nmin_aov2["moisture_tx", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(Nmin_aov2["moisture_tx", "Pr(>F)"], 3), nsmall = 3))`) and temperature (`r paste0("F", sub_digits(Nmin_aov2["temp_tx", "Df"]), "\u02CC", sub_digits(Nmin_aov2["Residuals", "Df"]), " = ", format(round(Nmin_aov2["temp_tx", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(Nmin_aov2["temp_tx", "Pr(>F)"], 3), nsmall = 3))`) conditions; mean total N mineralization decreased under saturated field-moist vs. conditions and increased at 20 &deg;C vs. 12 &deg;C. Furthermore, a significant temperature by destructive sampling time interaction effect (`r paste0("F", sub_digits(Nmin_aov2["temp_tx:destructive_time", "Df"]), "\u02CC", sub_digits(Nmin_aov2["Residuals", "Df"]), " = ", format(round(Nmin_aov2["temp_tx:destructive_time", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(Nmin_aov2["temp_tx:destructive_time", "Pr(>F)"], 3), nsmall = 3))`) demonstrates that mean total N mineralization in mesocosms assigned to 20 &deg;C decreased at T~2~ following a three-week return to 12 &deg;C field-moist conditions. There were no significant block effects (`r paste0("F", sub_digits(Nmin_aov2["block_effect", "Df"]), "\u02CC", sub_digits(Nmin_aov2["Residuals", "Df"]), " = ", format(round(Nmin_aov2["block_effect", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(Nmin_aov2["block_effect", "Pr(>F)"], 3), nsmall = 3))`) and destructive sampling treatments did not affect N mineralization (`r paste0("F", sub_digits(Nmin_aov2["destructive_time", "Df"]), "\u02CC", sub_digits(Nmin_aov2["Residuals", "Df"]), " = ", format(round(Nmin_aov2["destructive_time", "F value"], 3), nsmall = 3))`, `r paste0("p = ", format(round(Nmin_aov2["destructive_time", "Pr(>F)"], 3), nsmall = 3))`). No other interaction effects significantly affected N mineralization ([Appendix E]). Mean total N mineralization (&plusmn; SE) under each treatment is presented in [Appendix D]. Estimates of effect size based on a linear model are given in [Appendix F].
<br>
  
### Supplemental Table N+3
Nitrogen mineralization ANOVA results.
```{r Flux Results 8, warning = F}
...
## Appenix A
Node model parameters for the soil food web trophic groups under control (12 &deg;C) and warmed (20 &deg;C) conditions.  
  
Parameters include C:N and estimated percent assimilation efficiency (E~a~), percent production efficiency (E~p~), and population death rates (d).^1,2,3^
```{r Appendix A, warning = F}
...
```
^1^Metabolic parameters from [Hunt et al. (1987)](https://doi.org/10.1007/BF00260580).  
^2^Metabolic scaling of parameters for microbial nodes from [Li et al. (2019)](https://doi.org/10.1111/gcb.14517).  
^3^Metabolic scaling of parameters for soil fauna nodes from Luxton ([1972](https://eurekamag.com/research/000/208/000208036.php), [1981](https://doi.org/10.1016/S0031-4056(23)03677-6)).
<br>
...
Biomasses (&plusmn; SE) are given in g of C per m^2^ of soil under each experimental treatment. Meso = arthropod-feeding mites, Zerco = nematode-feeding mites, Mites NP = non-predatory prostigmatid and astigmatid mites, Col = collembola, Pred Nem = predatory nematodes, Bac Nem = bactivorous nematodes, Fung Nem = fungivorous nematodes, Omni Nem = omnivorous nematodes, Pro = protists, Bact = bacteria, Fung = fungi, Labile = labile detritus, Recal = recalcitrant detritus.
```{r Appendix C, warning = F}
...
Mean value (&plusmn; SE) for each variable measured. Heterotrophic respiration is given in g of C per m^2^ per year; soil moisture is given in ln(percent) gravimetrically; pH is given in ln(pH); C:N ratio is a unitless quantity; phenol oxidase and peroxidase concentration is given in &mu;Mol substrate per g soil per hour; total abundance and microfauna abundance is given in individuals per m^2^; mesofauna abundance is given in ln(individuals per m^2^); total biomass is given in g of C per m^2^; consumptive flux and C mineralization are given in g of C per m^2^ per year; N mineralization is given in g of N per m^2^ per year.
```{r Appendix D, warning = F}
...
ANOVA output for each variable measured. Heterotrophic respiration is given in ln(g of C per m^2^ per year); soil moisture is given in ln(percent) gravimetrically; pH is given in ln(pH); C:N ratio is a unitless quantity; phenol oxidase and peroxidase concentration is given in &mu;Mol substrate per g soil per hour; total abundance and microfauna abundance is given in individuals per m^2^; mesofauna abundance is given in ln(individuals per m^2^); total biomass is given in in g of C per m^2^; consumptive flux and C mineralization are given in g of C per m^2^ per year; N mineralization is given in g of N per m^2^ per year.
```{r Appendix E, warning = F}
sub_digits <- function(x) {
  subs <- c("₀","₁","₂","₃","₄","₅","₆","₇","₈","₉")
  digits <- strsplit(as.character(x), "")[[1]]
  paste0(subs[as.integer(digits) + 1], collapse = "")
...
Estimate of coefficient (&plusmn; SEM) for each variable measured, based on corresponding linear models. Heterotrophic respiration is given in ln(g of C per m^2^ per year); soil moisture is given in ln(percent) gravimetrically; pH is given in ln(pH); C:N ratio is a unitless quantity; phenol oxidase and peroxidase concentration is given in &mu;Mol substrate per g soil per hour; total abundance and microfauna abundance is given in individuals per m2; mesofauna abundance is given in ln(individuals per m^2^); total biomass is given in in g of C per m^2^; consumptive flux and C mineralization are given in g of C per m^2^ per year; N mineralization is given in g of N per m^2^ per year.
```{r Appendix F, warning = F}
lm_terms <- c(
  "(Intercept)",
  "moisture_txHigh",
  "temp_tx20",
